...
export default class ModalSelector extends React.Component {
    ...
    renderSection = (section) => {
        ...
        return (
            <View key={this.props.keyExtractor(section)}
    ...
    renderOption = (option, isLastItem, isFirstItem) => {
        ...
        let component = optionComponent || (
            <Text
                style={[styles.optionTextStyle, this.props.optionTextStyle, isSelectedItem && this.props.selectedItemTextStyle]} {...this.props.optionTextPassThruProps}>
                {optionLabel}
            </Text>
        )
        if (this.props.renderItem){
            return this.props.renderItem(optionLabel,option);
        } else {
            return (
                <TouchableOpacity
                ...
                >
                    <View
                        style={[styles.optionStyle, this.props.optionStyle, isLastItem && { borderBottomWidth: 0 }]}>
                        {component}
                    </View>
                </TouchableOpacity>)
        }
    ...
    renderOptionList = () => {
        ...
        return (
            <TouchableWithoutFeedback key={'modalSelector' + (componentIndex++)} accessible={false}
                                      onPress={() => {
    ...
    renderChildren = () => {
        ...
        return (
            <View style={[styles.selectStyle, this.props.selectStyle]}>
                <Text
                    style={[styles.selectTextStyle, this.props.selectTextStyle]} {...this.props.selectTextPassThruProps}>{this.state.selected}</Text>
            </View>
        )
    }
